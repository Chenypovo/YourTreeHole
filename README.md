...
Runtime data is stored under `data/` and is ignored by Git. This folder can contain private journal entries, memories, profile summaries, and relationship state. Do not commit it unless you intentionally want to publish that data.
